# 1/6/23
# https://figurl.org/f?v=gs://figurl/figneuro-1&d=sha1://03cdc207a82823114f86dcffc02f7aa52a442682&label=Spike%20locations%20example
...
def example_spike_locations(*, recording: si.BaseRecording, sorting: si.BaseSorting, hide_unit_selector: bool=False, height=500):
    ...
    items: List[ssv.SpikeLocationsItem] = []
