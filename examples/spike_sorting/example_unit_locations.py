# 1/6/23
# https://figurl.org/f?v=gs://figurl/figneuro-1&d=sha1://06d6684207b201ad8e389329e29d0d2fc0f74193&label=Unit%20locations%20example
...
def example_unit_locations(*, recording: si.BaseRecording, sorting: si.BaseSorting, height=400):
    ...
    for ii, unit_id in enumerate(unit_ids):
        unit_items.append(ssv.UnitLocationsItem(
            unit_id=unit_id,
