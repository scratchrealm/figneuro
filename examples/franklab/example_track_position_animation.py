# 1/26/23
# https://figurl.org/f?v=gs://figurl/figneuro-1&d=sha1://5c664307f3ba9d1a8136e3cc2716f43cb45b05bd&label=Track%20position%20animation%20example

import numpy as np
import figneuro.franklab.views as flv
...
def example_track_position_animation(*, height=800):
    ...
    decoded_position_data = flv.DecodedPositionData(
        x_min=0,
        bin_width=1,
        x_count=x_count,
        y_min=0,
    ...
    view = flv.TrackPositionAnimationV1(
        track_bin_width=1,
        track_bin_height=1,
