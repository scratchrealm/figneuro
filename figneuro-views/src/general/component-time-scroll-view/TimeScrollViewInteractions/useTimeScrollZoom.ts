...
const zoomUpdate: DebounceThrottleUpdater<ZoomStateProperties, ZoomStateRefs> = (refs: ZoomStateRefs, state: ZoomStateProperties) => {
    const { divRef } = refs
...
const zoomResolver: DebounceThrottleResolver<ZoomStateRefs, ZoomResolverProps> = (refs: ZoomStateRefs, props: ZoomResolverProps) => {
