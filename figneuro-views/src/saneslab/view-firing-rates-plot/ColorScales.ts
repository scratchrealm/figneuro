...
export const useColorMapFunction = (colorMap: ValidColorMap, colorMapRangeMax: number) => {
    ...
    return { colorMapFunction, primaryContrastColor: ColorScaleContrastColors[colorMap], secondaryContrastColor: SecondaryContrastColors[colorMap] }
}